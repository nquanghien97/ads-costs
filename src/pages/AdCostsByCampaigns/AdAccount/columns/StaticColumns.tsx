        ...
        return (
          <table className="h-full flex">
            <tbody className="w-full h-full flex flex-col justify-center items-center">
              {value.flatMap((innerData, index) => (
                index % 2 === 0 ? (
                  <tr key={innerData.ad_account?.campaign_id} className="min-h-[60px] max-h-[78px] !h-full w-full flex justify-center items-center">
                    <td>{innerData.ad_account?.campaign_id}</td>
                  </tr>
                ) : (
                  <tr key={innerData.ad_account?.campaign_id} className="min-h-[60px] max-h-[78px] !h-full w-full flex justify-center items-center !bg-[#e9e9e9]">
                    <td>{innerData.ad_account?.campaign_id}</td>
                  </tr>
                )
              ))}
